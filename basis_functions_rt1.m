...
for T = 1:triangles
    ...
    basis{eone,1,T} =@(r,z) sigma(one).*sqrt(2).*(1./detJt).*((a4.*r ...
        + a5.*z + a6 - g2)./(g1 - g2)).*(Jta.*(a1.*r + a2.*z + a3) ...
        + Jtb.*(a4.*r + a5.*z + a6));
    
    basis{eone,2,T} =@(r,z) sigma(one).*sqrt(2).*(1./detJt).*((a4.*r ...
    ...
    basis{efour,1,T} =@(r,z) sigma(one).*sqrt(2).*(1./detJt).*((a4.*r ...
        + a5.*z + a6 - g1)./(g2 - g1)).*(Jta.*(a1.*r + a2.*z + a3) ...
        + Jtb.*(a4.*r + a5.*z + a6));
            
    basis{efour,2,T} =@(r,z) sigma(one).*sqrt(2).*(1./detJt).*((a4.*r ...
    ...
    basis{7,1,T} =@(r,z) (1./detJt).*(a4.*r + a5.*z + a6).*(Jta.*(a1.*r ...
        + a2.*z + a3)+ Jtb.*(a4.*r + a5.*z + a6 - 1));
    
    basis{7,2,T} =@(r,z) (1./detJt).*(a4.*r + a5.*z + a6).*(Jtc.*(a1.*r ...
    ...
    basis_div{efour,T} =@(r,z) sigma(one).*sqrt(2).*(1./detJt).*(Jta.*( 2.*c4.*a1.*r ...
