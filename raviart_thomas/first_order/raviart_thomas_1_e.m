function [err] = raviart_thomas_1_e(f_vec_r,f_vec_z,gd,sf,ns,mesh,u_vec_r,u_vec_z)
...
%
% Syntax:
%     [err] = raviart_thomas_1_e(f_vec_r,f_vec_z,gd,sf,ns,mesh,u_vec_r,u_vec_z)
%
% Inputs:
...
if mesh > 1
    ...
    err(1) = errors_exact_rt1(p,t,ed,t_ed,basis,x,u_vec_r,u_vec_z);
    ...
    for i = 2:mesh
        ...
        [basis,x] = solve(p,e,t,ed,t_ed,f_vec_r,f_vec_z);
        err(i) = errors_exact_rt1(p,t,ed,t_ed,basis,x,u_vec_r,u_vec_z);
    end
    display_errors(err);
...
function [basis,x] = solve(p,e,t,ed,t_ed,f_vec_r,f_vec_z)
    [basis, basis_div] = basis_functions_rt1(p,t,ed,t_ed);
    S = stiffness_matrix_rt1(p,t,ed,t_ed,basis,basis_div);
