function stiffness_matrix = stiffness_matrix_weighted_fourier_rt(p,t,ed,t_ed,basis_edges,basis_triangles,n)
% STIFFNESS_MATRIX_WEIGHTED_FOURIER_RT - Create stiffness matrix
%
% Syntax:
%     A = stiffness_matrix_weighted_fourier_rt(p,t,ed,t_ed,basis)
%
% Inputs:
...
for T = 1:triangles
    ...
    for i = 1:4
        for j = i:4
            ...
            div_ij =@(r,z) div_i(r,z).*div_j(r,z);
            
            integrand =@(r,z) (div_ij(r,z) + dot_ij(r,z)).*r;
...
stiffness_matrix = sparse(i_vec,j_vec,s_vec,edges+triangles,edges+triangles);
